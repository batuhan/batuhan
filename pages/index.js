...
export default function Home() {
  return (
    <div className="container">
      ...
      <div className="container">
        <img src="/avatar-shitquality.jpg" className="profile-image" alt="Fırat Batuhan İçöz" />

        <h1>f. batuhan içöz</h1>
        <p>digital maker, investor & software engineer</p>
        <h2>currently</h2>
        <ul>
          <li>
            engineering at <a href="https://www.texts.com/?ref=bt.hn">Texts</a>
          </li>
          <li>
            investor & consultant at <a href="https://komunite.com.tr/?ref=bt.hn">Komünite</a> & <a
              href="https://tmlab.studio/?ref=bt.hn">tmlab</a>
          </li>
        </ul>
        ...
        <ul>
          <li>
            freelance digital product + startup consultant at <a href="https://pickled.works">pickled.works</a>
          </li>
          <li>
            (mostly) political live streams (mostly) in Turkish at <a href="https://twitch.tv/susbatuhan">twitch</a>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>2022</strong> interim cto at{" "}
            <a href="https://omnicourse.io/?ref=bt.hn">an audio learning platform</a>
          </li>
          <li>
          ...
          <li>
            <strong>2017</strong> senior product engineer at{" "}
            <a href="https://www.talkjs.com/?ref=bt.hn">an awesome chat solution for marketplaces</a>
          </li>
          <li>
